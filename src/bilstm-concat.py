...
def test(vocab_df):
    ...
    model = load_model('model/bi-lstm-feature/hiddenlayer 64/memory units 128/biLSTM-15-0.68-128units-64nodes.h5')

    test_data_df = get_and_preprocess_data(PATH_DATA_TEST_MORE_INFO, separator='\t', more_info=True)
